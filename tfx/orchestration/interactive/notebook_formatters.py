...
class NotebookFormatter(object):
  ...
  _DEFAULT_TITLE_FORMAT = ('<span class="classname">%s</span>',
                           ['__class__.__name__'])
...
FORMATTER_REGISTRY = _create_formatters({
    Artifact: {
        ...
        'title_format': (
            ('<span class="classname">%s</span> of type '
             '<span class="classname">%r</span> (uri: %s)'),
    ...
    Channel: {
        ...
        'title_format': (
            ('<span class="classname">%s</span> of type '
             '<span class="classname">%r</span> (%d artifact%s)'),
            [
