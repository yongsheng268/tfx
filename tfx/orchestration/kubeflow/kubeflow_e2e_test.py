...
class KubeflowEndToEndTest(tf.test.TestCase):
  ...
  def setUp(self):
    ...
    self._project_id = os.environ['KFP_E2E_PROJECT_ID']
    self._bucket_name = os.environ['KFP_E2E_BUCKET_NAME']
    self._data_root = os.environ['KFP_E2E_DATA_ROOT']
    self._taxi_module_file = os.environ['KFP_E2E_TAXI_MODULE_FILE']
